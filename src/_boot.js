...
process.on("uncaughtException", e => {
    signale.fatal(e);
    dialog.showErrorBox("Draconic-OS crashed", e.message || "Cannot retrieve error message.");
    if (tty) {
        tty.close();
    }
    if (extraTtys) {
...
signale.start(`Starting Draconic-OS v${app.getVersion()}`);
